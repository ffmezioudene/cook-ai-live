...
export default function Emotional1Screen() {
      ...
      <SafeAreaView style={styles.content}>
        ...
        >
          <View style={styles.iconCircle}>
            <Ionicons name="happy" size={60} color={colors.success} />
          </View>
        </Animated.View>
        ...
        >
          <Text style={styles.title}>Cook with{' \n'}confidence</Text>
        ...
        >
          <Button
            title="Continue"
            onPress={() => router.push('/(onboarding)/emotional2')}
            size="lg"
          />
        </Animated.View>
      </SafeAreaView>
