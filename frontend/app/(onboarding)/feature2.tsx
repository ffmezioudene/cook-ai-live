      ...
      <SafeAreaView style={styles.content}>
        ...
        >
          <View style={styles.iconCircle}>
            <Ionicons name="play-circle" size={60} color={colors.error} />
          </View>
        </Animated.View>
        ...
        >
          <Text style={styles.title}>Watch and{' \n'}learn</Text>
          <Text style={styles.description}>
            Every recipe links to YouTube videos{' \n'}so you can follow along step by step
          </Text>
        </Animated.View>
        ...
        >
          <Button
            title="Next"
            onPress={() => router.push('/(onboarding)/feature3')}
            size="lg"
          />
        </Animated.View>
      </SafeAreaView>
